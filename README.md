...
### 7. Set up 404.html for single-page apps (React)

To ensure that endpoints other than the index.html route (username.github.io/endpoint) are found and handled correctly by Github Pages, you need to ensure that the custom 404.html file is set correctly for your scenario. **Ensure you correctly set the pathSegmentsToKeep variable**.
This code and idea came from [spa-github-pages](https://github.com/rafgraph/spa-github-pages)
